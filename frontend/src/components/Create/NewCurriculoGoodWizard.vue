<template>
    ...
    <vue-good-wizard 
      ...
      :nextStepLabel="prosseguir"
      :finalStepLabel="salvar">
        <div slot="page1">
                <div class="form-group ">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" for="nome">Nome Completo *</span>
                        </div>
                    <ValidationProvider name="nome" rules="required|max:50">
                        <input type="nome" id="nome" name="nome" class="form-control" v-model="nome" maxlength="50">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" for='Genero'>Gênero *</span>
                        </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                                <span class="input-group-text" for='Estado Civil'>Estado Civil *</span>
                        </div>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-prepend">
                                <span class="input-group-text" for="pais">País de Nacionalidade*</span>
                        </div>
        ...
        <div slot="page2">
            ...
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" for="linkedin">Linkedin *</span>
                    </div>
                    <ValidationProvider name="linkedin" rules="max:50">
                        <input type="linkedin" id="linkedin" name="linkedin" class="form-control" v-model="linkedin" maxlength="50">
                    <!-- <div slot-scope="{ errors }"> <p>{{ errors[0] }}</p></div> -->
                </ValidationProvider>
                </div>
			</div>
            ...
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" for="facebook">Facebook *</span>
                    </div>
                    <ValidationProvider name="facebook" rules="max:50">
                        <input type="facebook" id="facebook" name="facebook" class="form-control" v-model="facebook" maxlength="50">
                    <!-- <div slot-scope="{ errors }"><p>{{ errors[0] }}</p></div> -->
                </ValidationProvider>
                </div>
	        </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-prepend">
                            <span class="input-group-text" for="twitter">Twitter *</span>
                    </div>
                    <ValidationProvider name="twitter" rules="max:50">
                            <input type="twitter" id="twitter" name="twitter" class="form-control" v-model="twitter" maxlength="50">
                        <!-- <div slot-scope="{ errors }"> <p>{{ errors[0] }}</p> </div> -->
                    </ValidationProvider>
                </div>
	        </div>
             ...
             <div class="form-group">
                <div class="input-group">
                    <div class="input-group-prepend">
                            <span class="input-group-text" for="site">Site *</span>
                    </div>
                    <ValidationProvider name="site" rules="max:50">
                            <input type="site" id="facebook" name="site" class="form-control" v-model="site" maxlength="50">
                        <!-- <div slot-scope="{ errors }"><p>{{ errors[0] }}</p></div> -->
                    </ValidationProvider>
                </div>
            </div>
        ...
        <div slot="page3">
            ...
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-prepend">
                            <span class="input-group-text" for="pais">País *</span>
                    </div>
                    <select class="custom-select" name="pais" v-model="pais">
                        <option value="" disabled selected>Selecione a opção</option>
                        <option value="África do Sul" selected>Seleciona a opção</option>
            ...
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" for="estado">Estado *</span>
                    </div>
            ...
            <div class="form-group ">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" for="nome">Rua *</span>
                    </div>
            ...
            <div class="form-group ">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" for="nome">Número *</span>
                    </div>
                    <ValidationProvider name="numero" rules="required|max:50">
                        <input type="text" class="form-control" name="numero" v-model="numero" maxlength="50">
                    <!-- <div slot-scope="{ errors }"><p>{{ errors[0] }}</p></div> -->
                </ValidationProvider>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <ValidationProvider name="complemento" rules="required|max:500">
                    <textarea id="complemento" class="md-textarea form-control" name="complemento" v-model="complemento" maxlength="500"></textarea>
                    <!-- <div slot-scope="{ errors }"><p>{{ errors[0] }}</p></div> -->
                </ValidationProvider>
                </div>
            </div>
            ...
            <div class="form-group">
                <label for="pais">* Nível de Escolaridade</label>
                    ...
                    <option selected>Selecione a opção</option>
                        ...
                        <option value="AP">Ensino Fundamental(Completo)</option>
                        <option value="AM">Ensino Médio(Incompleto)</option>
                        <option value="AM">Ensino Médio(Cursando)</option>
                        <option value="AM">Ensino Médio(Completo)</option>
                        <option value="BA">Ensino Superior(Incompleto)</option>
                        <option value="BA">Ensino Superior(Cursando)</option>
