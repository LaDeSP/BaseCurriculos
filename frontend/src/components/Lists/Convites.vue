    ...
    <span v-else>
        ...
        <div v-else>
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div v-if="!toggle">
                        <h2><center>Convites</center></h2><br><br>
                    </div>
                    <div v-else>
                        <h2><center>Convidados</center></h2>
                    </div>
                            ...
                            <List class="mb-4 col-md-12" v-for="show in pageOfItems" :key="show.id" :id="show.id">
                                <template v-slot:list-header>
                                    <h3 class="mb-1" style="color: #4E73DF;">{{show.curriculo.fisica.user.name}}
                                        ...
                                        <span v-if="show.resposta == 'CANCELADO'" class="badge badge-danger">VOCÊ CANCELOU ESSE CONVITE</span>
                                        <span v-if="show.resposta == 'RECUSOU'" class="badge badge-warning">RECUSOU</span>
                                        <span v-if="show.resposta == 'ACEITOU'" class="badge badge-success">ACEITOU</span>
                                    </h3>
                                </template>
