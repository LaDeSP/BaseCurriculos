 ...
 <v-row align="center" justify="center">
    <v-col cols="12" lg="12" md="12" sm="10" v-if="isLoaded">
      ...
      <v-card align="center">
        ...
        <template v-if="!toggle && tipoPermissao == 'JURIDICA'">
          <v-row  align="center" justify="center">
            <v-col cols="12" lg="12" md="8" sm="12" v-for="value in getVagasThatHaveCandidaturas" :key="value.id">
              <v-card>
                {{value}}
                <v-title class="primary--text text-center justify-center">
                ...
                <v-card-actions class="justify-center text-center"> 
                  <v-btn @click="toggle = true" color="primary">
                    Ver Candidatos
                  </v-btn>
                </v-card-actions>
              </v-card>
              ...
              <v-card-text> 
                <v-row justify="center">
                  <template v-if="getCandidaturas.length == 0">
                    <span style="font-size: 20px">Não há nenhuma candidatura.</span>
                  </template>
                  <template v-else>
